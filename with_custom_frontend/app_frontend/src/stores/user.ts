...
export const useUserStore = defineStore('user', () => {
  ...
  function logout() {
    token.value = ''
    userInfo.value = {modelId: '', userName: '', userAvatar: '', userEmail: '', userPhone: ''}
  ...
  return {token, userAvatar, userName, userInfo, isLoggedIn, handleLoginSuccess, fetchUserInfo, logout, initUser}
})
